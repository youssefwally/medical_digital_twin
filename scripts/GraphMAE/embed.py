...
def build_args():
    ...
    parser.add_argument("--save_path", type=str, default="../../../../../../vol/aimspace/users/wyo/latent_spaces/vertices_prediction")
...
if __name__ == '__main__':
    ...
    for dir in dirs:
        dgl_graph = get_single_subject(args.meshes_path, args.organ, str(dir))
        dgl_graph = dgl_graph.to(device)

        z = model.embed(dgl_graph, dgl_graph.ndata['feat'], False) #False if pool True otherwise  

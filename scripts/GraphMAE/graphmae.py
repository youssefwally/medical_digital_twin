...
def build_args():
    ...
    parser.add_argument("--path", type=str, default="../../../../../../vol/aimspace/users/wyo/smooth_meshes/2000/")
    ...
    parser.add_argument("--pooling_dim", type=int, default=0)
    parser.add_argument("--num_layers", type=int, default=5)
    parser.add_argument("--num_hidden", type=int, default=256)
    parser.add_argument("--residual", type=ast.literal_eval, default=True)
    parser.add_argument("--in_drop", type=float, default=0.000007)
    parser.add_argument("--attn_drop", type=float, default=0.01)
    ...
    parser.add_argument("--drop_edge_rate", type=float, default=0.12)
    parser.add_argument("--replace_rate", type=float, default=0.06)

    parser.add_argument("--encoder", type=str, default="gat")
    parser.add_argument("--decoder", type=str, default="gat")
    parser.add_argument("--loss_fn", type=str, default="mse") 
    parser.add_argument("--alpha_l", type=int, default=2) #pow coefficient for sce loss
    parser.add_argument("--optimizer", type=str, default="adadelta")

    parser.add_argument("--max_epoch_f", type=int, default=20)
    parser.add_argument("--lr_f", type=float, default=0.0001)
    parser.add_argument("--weight_decay_f", type=float, default=0.01)
    parser.add_argument("--linear_prob", type=ast.literal_eval, default=True)
    parser.add_argument("--concat_hidden", type=ast.literal_eval, default=False)
...
if __name__ == '__main__':
    ...
    if(wandb.config.save):
        torch.save(model, f'../models/{args.organ}_smooth_graphmae_{args.encoder}_{args.decoder}.pt')
